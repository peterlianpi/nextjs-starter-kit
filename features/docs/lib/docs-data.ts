    ...
    body: [
      ...
      { type: "h2", text: "Current state by area" },
      {
        ...
        rows: [
          ...
          ["Blog", "posts router (/api/posts CRUD)", "Admin editor pages + SSR reader at /blog/[slug]; public index at /blog — complete"],
          ["Media", "upload router (multi-provider storage)", "/admin/media grid with crop pipeline — complete for admins"],
          ["Search", "search router (/api/search)", "/search page with debounced input, type filters, pagination — complete"],
          ["Notifications", "notifications router (mounted in the API catch-all)", "Bell popover + /notifications page with cursor-paginated list, mark-read flows — complete"],
          ...
          ["Organizations", "GET/POST /api/orgs live; Member/Invitation endpoints pending (Unit 16.10)", "Org switcher + role-aware nav shipped; member/invite management UI planned"],
          ["Timeline", "SystemMetric data + audit logs", "/admin/activity page (All/Audit/Metrics tabs, pagination) — complete"],
      ...
      { type: "h2", text: "Build units" },
      {
        type: "table",
        headers: ["#", "Unit", "Status"],
        rows: [
          ["16.1", "Public blog index at /blog", "✅ Complete (2026-08-25)"],
          ["16.2", "Role/account switch (org switcher, role-aware nav, account menu)", "✅ Complete (2026-08-25)"],
          ["16.3", "Notifications: mount router, bell dropdown, mark-read", "✅ Complete (2026-08-25)"],
          ["16.4", "Search surface on dashboard", "✅ Complete (2026-08-25)"],
          ["16.5", "Admin audit-log viewer", "Planned"],
          ["16.6", "API keys settings page", "Planned"],
          ["16.7", "Webhooks admin page + deliveries drawer", "Planned"],
          ["16.8", "Timeline/activity page", "✅ Complete (2026-08-25)"],
          ["16.9", "Settings persistence to UserPreferences", "Planned"],
          ["16.10", "Organizations end-to-end (API + switcher + members/invites)", "Planned — last"],
        ],
      },
      {
        type: "note",
